...
function blockStyle(color: string): React.CSSProperties {
  return {
    background: `linear-gradient(155deg, ${color} 0%, ${color} 60%, rgba(0,0,0,0.18) 100%)`,
    boxShadow:
      "inset 0 -4px 0 rgba(0,0,0,0.25), inset 0 3px 0 rgba(255,255,255,0.35), 0 2px 4px rgba(0,0,0,0.35)",
  };
}
